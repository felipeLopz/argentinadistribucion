    ...
    <section id="contacto" className="font-archivo py-20">
      <div className="mx-auto max-w-[1240px] px-5 sm:px-7">
        ...
        <div className="mb-11 text-center">
          <span className="mb-[18px] inline-flex items-center gap-2 rounded-full border border-[var(--line)] bg-[rgba(196,191,183,0.12)] px-4 py-[7px] text-[13px] font-semibold text-[var(--blue-l)]">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <a
            ...
            className="group flex flex-col items-center rounded-[18px] border border-[var(--line)] bg-gradient-to-b from-[rgba(var(--navy-3-rgb),0.5)] to-[rgba(36,36,39,0.3)] p-7 text-center transition duration-300 hover:-translate-y-[5px] hover:border-[rgba(184,179,171,0.4)]"
          >
          ...
          <a
            ...
            className="group flex flex-col items-center rounded-[18px] border border-[var(--line)] bg-gradient-to-b from-[rgba(var(--navy-3-rgb),0.5)] to-[rgba(36,36,39,0.3)] p-7 text-center transition duration-300 hover:-translate-y-[5px] hover:border-[rgba(184,179,171,0.4)]"
          >
            <div className="grid h-[54px] w-[54px] place-items-center rounded-[15px] bg-[rgba(196,191,183,0.14)]">
          ...
          <div className="group flex flex-col items-center rounded-[18px] border border-[var(--line)] bg-gradient-to-b from-[rgba(var(--navy-3-rgb),0.5)] to-[rgba(36,36,39,0.3)] p-7 text-center transition duration-300 hover:-translate-y-[5px] hover:border-[rgba(184,179,171,0.4)]">
          ...
          {/* Envíos */}
          <div className="group flex flex-col items-center rounded-[18px] border border-[var(--line)] bg-gradient-to-b from-[rgba(var(--navy-3-rgb),0.5)] to-[rgba(36,36,39,0.3)] p-7 text-center transition duration-300 hover:-translate-y-[5px] hover:border-[rgba(184,179,171,0.4)]">
            <div className="grid h-[54px] w-[54px] place-items-center rounded-[15px] bg-[rgba(184,179,171,0.14)]">
