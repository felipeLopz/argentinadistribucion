        ...
        {filtered.length > 0 && (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-5 lg:gap-6">
            {filtered.map((product, i) => (
              <ProductCard key={product.id} product={product} index={i} onOpen={() => onProductClick(product)} />
            ))}
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 z-50 h-full w-full max-w-lg bg-white shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header con imagen de fondo */}
            <div className="relative h-64 sm:h-72 shrink-0 overflow-hidden bg-gradient-to-br from-[#0033A0]/10 to-[#D4AF37]/10">
              <img
                src={product.image}
                alt={product.name}
              ...
              <button
                onClick={onClose}
                className="absolute top-4 right-4 flex h-9 w-9 items-center justify-center rounded-full bg-white/20 backdrop-blur-md text-white hover:bg-white/40 transition-colors cursor-pointer"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              <div className="absolute top-4 left-4">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-white/20 backdrop-blur-md text-white px-3 py-1.5 text-xs font-bold">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                ...
                <p className="mt-1 text-sm text-white/80 line-clamp-2">{product.description}</p>
              </div>
            </div>
            ...
            <div className="px-5 pt-4 pb-3 border-b border-gray-100 space-y-2">
              <button
                onClick={consultarWhatsApp}
                className="w-full flex items-center justify-center gap-2 rounded-full bg-green-500 hover:bg-green-600 text-white h-11 font-bold text-sm shadow-md hover:shadow-lg transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
              >
                <MessageCircle className="h-4 w-4" />
                Consultar por WhatsApp
              </button>
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 rounded-full h-11 font-bold text-sm shadow-md transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer ${
                  showFeedback
                    ? "bg-green-500 text-white"
                    : tieneTalles && !talle
                    ? "bg-gray-200 text-gray-400 cursor-not-allowed"
                    : "bg-[#0033A0] hover:bg-[#0046D6] text-white hover:shadow-lg"
                }`}
              >
                {showFeedback ? (
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
                    ...
                    {talles.map((t) => {
                      ...
                      return (
                        <button
                          ...
                          disabled={agotado}
                          className={`relative flex flex-col items-center gap-0.5 rounded-xl border-2 px-4 py-3 min-w-[60px] transition-all ${
                            agotado
              ...
              <div>
                ...
                <div className={`flex items-center gap-4${tieneTalles && (!talle || stockTalle === 0) ? " opacity-40 pointer-events-none" : ""}`}>
                  <div className="flex items-center">
                    <button
                      onClick={restar}
                      className="flex h-11 w-11 items-center justify-center rounded-l-xl bg-gray-100 text-gray-700 font-bold text-xl hover:bg-gray-200 transition-colors active:scale-95 select-none cursor-pointer"
                    >
                      −
                    </button>
                    <div className="flex h-11 min-w-[64px] items-center justify-center bg-white border-y-2 border-gray-200 px-4">
                      <span className="text-xl font-extrabold text-gray-900 tabular-nums">{cantidad}</span>
                    </div>
                    <button
                      onClick={sumar}
                      className="flex h-11 w-11 items-center justify-center rounded-r-xl bg-[#0033A0] text-white font-bold text-xl hover:bg-[#0046D6] transition-colors active:scale-95 select-none cursor-pointer"
                    >
                      +
                    </button>
                  </div>
              ...
              <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
                <h3 className="text-sm font-bold text-gray-900 mb-1">Descripción</h3>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        <ProductSection sectionId="paquetes" category="paquetes" searchQuery={searchQuery} onProductClick={setSelectedProduct} />
        <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
        <ProductSection sectionId="albumes" category="albumes" searchQuery={searchQuery} onProductClick={setSelectedProduct} />
        <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
        <ProductSection sectionId="indumentaria" category="indumentaria" searchQuery={searchQuery} onProductClick={setSelectedProduct} />
        <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
        <ProductSection sectionId="accesorios" category="accesorios" searchQuery={searchQuery} onProductClick={setSelectedProduct} />
        <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
        <ProductSection sectionId="accesorios-apple" category="accesorios-apple" searchQuery={searchQuery} onProductClick={setSelectedProduct} />
        <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
