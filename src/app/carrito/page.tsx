...
export default function CarritoPage() {
      ...
      <input
        ...
        className={`w-full rounded-xl border bg-white/[0.04] px-4 py-3 text-sm text-[var(--ink)] placeholder:text-[var(--mut)] outline-none transition focus:ring-2 ${
          errores[id]
            ...
            : "border-[var(--line)] focus:border-[var(--gold)] focus:ring-[rgba(184,179,171,0.35)]"
        }`}
      />
      {errores[id] && (
  ...
  return (
    <div className="font-archivo min-h-screen bg-[var(--navy)] text-[var(--ink)]">
      ...
      <header className="sticky top-0 z-50 border-b border-[var(--line)] bg-[rgba(28,28,30,0.82)] backdrop-blur-[14px]">
          ...
          <div className="flex h-14 items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-[var(--blue-l)] to-[var(--blue)]">
                <Fish className="h-4 w-4 text-[#1c1c1e]" />
              </div>
            ...
            <div className="flex items-center gap-2">
              <div className="grid h-7 w-7 place-items-center rounded-full bg-gradient-to-br from-[var(--blue-l)] to-[var(--blue)]">
                <ShoppingCart className="h-3.5 w-3.5 text-[#1c1c1e]" />
              </div>
          ...
          {!enviado ? (
            ...
            >
              ...
              <div className="lg:col-span-3 space-y-4">
                ...
                {items.length === 0 ? (
                  <motion.div
                    ...
                    className="rounded-3xl border border-[var(--line)] bg-[rgba(var(--navy-3-rgb),0.5)] p-12 text-center"
                  >
                    ...
                    <Link
                      href="/"
                      className="inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-[var(--blue-l)] to-[var(--blue)] px-6 py-3 text-sm font-semibold text-[#1c1c1e] shadow-lg transition hover:-translate-y-px hover:brightness-110"
                    >
                    ...
                    <AnimatePresence>
                      {items.map((item) => (
                        <motion.div
                          ...
                          className="flex gap-4 rounded-2xl border border-[var(--line)] bg-gradient-to-b from-[rgba(var(--navy-3-rgb),0.6)] to-[rgba(36,36,39,0.4)] p-4"
                        >
                          <div className="relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-xl bg-[var(--navy-3)]">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="mt-2 flex items-center gap-3">
                              <div className="flex items-center">
                                ...
                                <button
                                  onClick={() => updateQuantity(item.productId, item.variante, item.cantidad + 1)}
                                  className="flex h-8 w-8 items-center justify-center rounded-r-lg bg-gradient-to-br from-[var(--blue-l)] to-[var(--blue)] text-sm font-bold text-[#1c1c1e] transition hover:brightness-110 active:scale-95 select-none cursor-pointer"
                                >
                                  +
                                </button>
                              </div>
                ...
                {items.length > 0 && (
                  <div className="rounded-2xl border border-[var(--line)] bg-[rgba(var(--navy-3-rgb),0.4)] p-4 text-sm text-[var(--mut)]">
              ...
              {items.length > 0 && (
                <div className="lg:col-span-2 space-y-6">
                  <div className="rounded-2xl border border-[var(--line)] bg-[rgba(var(--navy-3-rgb),0.5)] p-6">
                  ...
                  <div className="rounded-2xl border border-[var(--line)] bg-[rgba(var(--navy-3-rgb),0.5)] p-6">
                          ...
                          {HORARIOS.map((h) => (
                            <button
                              ...
                              className={`rounded-xl border-2 px-3 py-2.5 text-xs font-semibold transition-all cursor-pointer ${
                                horario === h
                                  ? "border-[var(--blue-l)] bg-gradient-to-br from-[var(--blue-l)] to-[var(--blue)] text-[#1c1c1e] shadow-md"
                    ...
                    <button
                      onClick={confirmar}
                      className="mt-6 flex h-12 w-full items-center justify-center gap-2 rounded-full bg-gradient-to-br from-[var(--blue-l)] to-[var(--blue)] text-base font-bold text-[#1c1c1e] shadow-lg transition hover:-translate-y-px hover:brightness-110 cursor-pointer"
                    >
            ...
            >
              ...
              <div className="flex w-full flex-col gap-3 sm:flex-row">
                <Link
                  href="/"
                  className="flex flex-1 items-center justify-center gap-2 rounded-full bg-gradient-to-br from-[var(--blue-l)] to-[var(--blue)] px-6 py-3.5 text-sm font-semibold text-[#1c1c1e] shadow-lg transition hover:-translate-y-px hover:brightness-110"
                >
                  <ArrowLeft className="h-4 w-4" />
                  Volver a la tienda
                </Link>
      ...
      <footer className="mt-12 border-t border-[var(--line)] bg-[rgba(28,28,30,0.5)] py-6">
